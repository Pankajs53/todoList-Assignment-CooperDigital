...
## 1. Project Overview
The To-Do List application is a full-stack web application designed to help users manage their daily tasks efficiently.
The backend is developed using Node.js and Express, and it uses MongoDB Atlas for cloud storage.
